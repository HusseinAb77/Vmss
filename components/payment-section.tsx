export function PaymentSection() {
  const methods = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 48 32" className="h-8 w-12" aria-hidden="true">
          ...
          />
          <path
            d="M30.5 8.3c.8.9 1.1 2.2.8 3.8-.8 4.3-3.5 6-7.2 6h-1.6c-.5 0-.9.4-1 .9l-.8 5.3c0 .3-.3.5-.6.5h-2.2l-.2 1.4c0 .3.2.5.5.5h3c.4 0 .8-.3.9-.7l.7-4.8c.1-.4.5-.8.9-.8h1.5c3.4 0 5.9-1.5 6.7-5.5.3-1.4.2-2.6-.4-3.5-.1-.4-.4-.7-.8-1.1-.1-.1-.1-.1-.2 0z"
    ...
    },
    {
      ...
      label: "Binance",
      icon: (
        // Simple Binance-like mark (clean + minimal)
        <svg
          viewBox="0 0 24 24"
    ...
    },
    {
      ...
      label: "USDT",
      icon: (
        // Simple USDT-like "T" coin (minimal + fits theme)
        <svg
          viewBox="0 0 24 24"
          className="h-8 w-8 text-muted-foreground transition-colors group-hover:text-foreground"
          fill="currentColor"
        ...
        <div className="rounded-2xl border border-border bg-card p-12">
          <div className="text-center">
            ...
            <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground">
              Choose the option that works for you — we’ll confirm details on WhatsApp.
            </p>
          </div>
